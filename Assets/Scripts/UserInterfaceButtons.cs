...
//	public GameObject Model;
	...
	public void RotationRightButton ()
	{
		...
		GameObject.FindWithTag ("Cube").transform.Rotate (0, -rotationSpeed * Time.deltaTime, 0);
	}
	...
	public void ScaleUpButton ()
	{
		// transform.localScale += new Vector3(scalingSpeed, scalingSpeed, scalingSpeed);
			GameObject.FindWithTag ("Cube").transform.localScale += new Vector3 (scalingSpeed, scalingSpeed, scalingSpeed);
		}
	...
	{
		GameObject.FindWithTag ("Cube").transform.Translate (0, 0, -translationSpeed * Time.deltaTime);
	}
	...
	{
		GameObject.FindWithTag ("Cube").transform.Translate (-translationSpeed * Time.deltaTime, 0, 0);
	}

	public void PositionLeftButton ()
	{
		GameObject.FindWithTag ("Cube").transform.Translate (translationSpeed * Time.deltaTime, 0, 0);  // backward
	}
